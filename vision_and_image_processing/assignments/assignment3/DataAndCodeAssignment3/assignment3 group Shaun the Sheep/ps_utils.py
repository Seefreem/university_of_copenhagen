...
def display_surface(z, albedo=None, title = '', elev=90, azim=0):
    """
    ...
    if surf_backend == "mayavi":
        ...
        display_surface_matplotlib(z, albedo=albedo, title=title, elev=elev, azim=azim)
...
def display_surface_matplotlib(z, albedo=None,  title = '',elev=90, azim=0):
    """
